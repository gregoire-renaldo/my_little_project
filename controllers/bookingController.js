...
exports.getCheckoutSession = catchAsync(async (req, res, next) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: `${req.protocol}://${req.get("host")}/?boat=${
      req.params.boatId
    }&user=${req.user.id}&price=${boat.price}`,
...
// add middleware to booking stack, in routes of course, to handle the query string with
